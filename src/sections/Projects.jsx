            ...
            <div className={`grid lg:grid-cols-2 grid-cols-1 
             mt-12 gap-5 w-full`}>
                ...
                py-10 px-5 shadow-2xl shadow-black-200`}>
                    ...
                    <div className={`p-3 backdrop-filter
                     backdrop-blur-3xl w-fit rounded-lg`}
                    ...
                    <div className={`flex flex-col gap-5 
                        ...
                        <p className={`text-white text-2xl 
                          font-semibold animatedText`}>{currentProject.title}</p>
                    ...
                    gap-5`}>
                        ...
                        <a className={`flex items-center gap-2 cursor-pointer
                         text-white-600`} href={currentProject.href} target="_blank"
                          rel="noreferrer">
                            <p>Check Live Site</p>
                            <img src="/assets/arrow-up.png"
                                 alt="arrow" className={`w-3 h-3`}/>
                        </a>
                    </div>
